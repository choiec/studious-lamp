...
T012–T041 remain unchecked (14 complete, 30 unchecked, 44 total). T012 is next, not started:
tooling GREEN only, followed by T013 clean-revision two-environment generation/evidence.
