...
108 PASS, full suite 114 PASS. T044 release-tooling repair is GREEN: 152 independent release regressions plus the unchanged
114 frozen checks PASS (266 total). T009–T041 remain unchecked (11 complete, 33 unchecked, 44 total).
...
The five dirty generated outputs remain preserved. T044 now repairs §§3.3 and 5.1–5.5 byte/source
bindings with exact-pinned rfc8785==0.1.4; this tooling PASS does not establish §7.1 candidate PASS.
Both complete conformance documents are packaged as two canonical JSONL records (23 historical
negative cases plus 78 semantic cases, including 28 unexecuted future-Core rejection obligations).
Vector completeness is not full conformance execution. T009 still owns the second-environment,
release regeneration and candidate evidence gates; publication/readback remain NOT RUN.
